...
import StarBreakerMod.actions.PutOnDeckBottomAction;

public class TestBottomCard
        extends CustomCard {
    public static final String ID = "StarBreaker:TestBottomCard";
    // private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    // Get object containing the strings that are displayed in the game.
    public static final String NAME = "TestBottomCard"; // cardStrings.NAME;
    ...
    public void triggerWhenDrawn() {
        if(isFirstDraw){
            StarBreakerMod.logger.info("trigger when drawn: TestBottomCard");
            AbstractPlayer p = AbstractDungeon.player;
            addToBot((AbstractGameAction)new PutOnDeckBottomAction((AbstractCreature)p, (AbstractCard)this));
