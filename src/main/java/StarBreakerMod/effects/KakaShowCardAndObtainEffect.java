...
public class KakaShowCardAndObtainEffect extends AbstractGameEffect {
    ...
    public KakaShowCardAndObtainEffect(AbstractCard card, float x, float y, boolean convergeCards) {
    ...
    public KakaShowCardAndObtainEffect(AbstractCard card, float x, float y) {
        this(card, x, y, true);
    }
    ...
    private void identifySpawnLocation(float x, float y) {
        ...
        while(var4.hasNext()) {
            ...
            if (e instanceof KakaShowCardAndObtainEffect) {
                ++effectCount;
            }
        }
